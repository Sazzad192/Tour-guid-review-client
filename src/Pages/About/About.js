    ...
    return (
        <div className='w-4/5 mx-auto my-28 text-center text-white'>
            ...
            <div className='grid sm:grid-cols-1 lg:grid-cols-2 gap-4 my-10'>
                <img className='max-h-80 sm:w-5/6 lg:max-w-5/6 rounded-md border-2' src={img1} alt="" />
                <div className='text-left'>
                    ...
                    <div className='pt-5'>
                        ...
                        <ul style={{listStyleType: ondrop}}>
                            <li># Toure guide with package</li>
                            <li># International tour consultancy and guide</li>
                            <li># Reserve car and hotel </li>
